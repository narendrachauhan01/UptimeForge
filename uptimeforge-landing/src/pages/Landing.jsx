...
export default function Landing() {
  ...
  const renderIntegrationsTab = () => {
    ...
    const customWebhooks = [
      ...
      { id: 'slack', name: 'Slack', desc: 'Send alerts to your Slack channel via incoming webhook.', icon: <svg viewBox="0 0 24 24" fill="currentColor" width="18" height="18" style={{color:'#4a154b'}}><path d="M5.042 15.165a2.528 2.528 0 0 1-2.52 2.523A2.528 2.528 0 0 1 0 15.165a2.527 2.527 0 0 1 2.522-2.52h2.52v2.52zm1.271 0a2.527 2.527 0 0 1 2.521-2.52 2.527 2.527 0 0 1 2.521 2.52v6.313A2.528 2.528 0 0 1 8.834 24a2.528 2.528 0 0 1-2.521-2.522v-6.313zM8.834 5.042a2.528 2.528 0 0 1-2.521-2.52A2.528 2.528 0 0 1 8.834 0a2.528 2.528 0 0 1 2.521 2.522v2.52H8.834zm0 1.271a2.528 2.528 0 0 1 2.521 2.521 2.528 2.528 0 0 1-2.521 2.521H2.522A2.528 2.528 0 0 1 0 8.834a2.528 2.528 0 0 1 2.522-2.521h6.312zm10.122 2.521a2.528 2.528 0 0 1 2.522-2.521A2.528 2.528 0 0 1 24 8.834a2.528 2.528 0 0 1-2.522 2.521h-2.522V8.834zm-1.268 0a2.528 2.528 0 0 1-2.523 2.521 2.527 2.527 0 0 1-2.52-2.521V2.522A2.527 2.527 0 0 1 15.165 0a2.528 2.528 0 0 1 2.523 2.522v6.312zm-2.523 10.122a2.528 2.528 0 0 1 2.523 2.522A2.528 2.528 0 0 1 15.165 24a2.527 2.527 0 0 1-2.52-2.522v-2.522h2.52zm0-1.268a2.527 2.527 0 0 1-2.52-2.523 2.526 2.526 0 0 1 2.52-2.52h6.313A2.527 2.527 0 0 1 24 15.165a2.528 2.528 0 0 1-2.522 2.523h-6.313z"/></svg>, color: '#4a154b', status: integrations.slack },
      { id: 'discord', name: 'Discord', desc: 'Post status updates to your Discord server.', icon: '👾', color: '#5865F2', status: integrations.discord },
    ];
    const comingSoon = [
      { name: 'Mattermost', desc: 'Send alerts to your Mattermost channel.', icon: '💠' },
      { name: 'MS Teams', desc: 'Post status updates to a Microsoft Teams channel.', icon: '👥' },
      { name: 'Google Chat', desc: 'Send alerts to a Google Chat space.', icon: '💬' },
      { name: 'Splunk', desc: 'Forward alert events to Splunk for analysis.', icon: '📊' },
    ];
  ...
  return (
    <div className="lp">
      ...
      <section className="lp-hero">
        ...
        <div className="lp-hero-wrap-centered">
          ...
          <div className="lp-hero-trust">
            {['5-day free trial', 'Alerts in under 1 min', 'Email · Telegram · Slack', 'No hidden charges'].map(t => (
      ...
      <div className="lp-stats-bar">
        {[['30s–5m', 'Check Interval'], ['24/7', 'Always On'], ['< 1 min', 'Alert Speed'], ['Email + 5 more', 'Alert Channels'], ['₹2', 'Trial Cost'], ['8+', 'Monitoring Types']].map(([v, l]) => (
            ...
            {(() => { let _integIdx = -1; return [
              {
                ...
                items: [
                  ...
                  },
                  {
                    ...
                    icon: (
                      <svg viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg" className="lp-integ-logo">
              ...
              },
              {
                ...
                items: [
                  ...
                  },
                  {
                    ...
                    icon: (
                      <svg viewBox="0 0 345 304" xmlns="http://www.w3.org/2000/svg" className="lp-integ-logo" style={{width:32,height:32}}>
                  ...
                  },
                  {
                    ...
                    icon: (
                      <svg viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg" className="lp-integ-logo">
                        <path d="M5.042 15.165a2.528 2.528 0 0 1-2.52 2.523A2.528 2.528 0 0 1 0 15.165a2.527 2.527 0 0 1 2.522-2.52h2.52v2.52zm1.271 0a2.527 2.527 0 0 1 2.521-2.52 2.527 2.527 0 0 1 2.521 2.52v6.313A2.528 2.528 0 0 1 8.834 24a2.528 2.528 0 0 1-2.521-2.522v-6.313zM8.834 5.042a2.528 2.528 0 0 1-2.521-2.52A2.528 2.528 0 0 1 8.834 0a2.528 2.528 0 0 1 2.521 2.522v2.52H8.834zm0 1.271a2.528 2.528 0 0 1 2.521 2.521 2.528 2.528 0 0 1-2.521 2.521H2.522A2.528 2.528 0 0 1 0 8.834a2.528 2.528 0 0 1 2.522-2.521h6.312z" fill="#E01E5A"/>
                        <path d="M18.956 8.834a2.528 2.528 0 0 1 2.522-2.521A2.528 2.528 0 0 1 24 8.834a2.528 2.528 0 0 1-2.522 2.521h-2.522V8.834zm-1.268 0a2.528 2.528 0 0 1-2.523 2.521 2.527 2.527 0 0 1-2.52-2.521V2.522A2.527 2.527 0 0 1 15.165 0a2.528 2.528 0 0 1 2.523 2.522v6.312zM15.165 18.956a2.528 2.528 0 0 1 2.523 2.522A2.528 2.528 0 0 1 15.165 24a2.527 2.527 0 0 1-2.52-2.522v-2.522h2.52zm0-1.268a2.527 2.527 0 0 1-2.52-2.523 2.526 2.526 0 0 1 2.52-2.52h6.313A2.527 2.527 0 0 1 24 15.165a2.528 2.528 0 0 1-2.522 2.523h-6.313z" fill="#ECB22E"/>
                        <path d="M5.042 8.834a2.527 2.527 0 0 1-2.52-2.521A2.527 2.527 0 0 1 5.042 3.79a2.527 2.527 0 0 1 2.521 2.522v2.521H5.042zm1.271 0a2.527 2.527 0 0 1 2.521-2.521h6.312a2.528 2.528 0 0 1 2.521 2.521 2.528 2.528 0 0 1-2.521 2.523H8.834A2.528 2.528 0 0 1 6.313 8.834z" fill="#2EB67D"/>
                        <path d="M15.165 18.956h-2.521v-2.521a2.527 2.527 0 0 1 2.521-2.522 2.528 2.528 0 0 1 2.523 2.522 2.528 2.528 0 0 1-2.523 2.521zm0-1.268H8.853a2.528 2.528 0 0 1-2.521-2.523 2.527 2.527 0 0 1 2.521-2.52h6.312a2.527 2.527 0 0 1 2.523 2.52 2.528 2.528 0 0 1-2.523 2.523z" fill="#36C5F0"/>
                      </svg>
                    ),
                    badge: '+ Add',
                    actionType: 'add'
              ...
              },
              {
                ...
                items: [
                  {
                    name: 'Mattermost',
                    desc: 'Send alerts to your Mattermost channel.',
                    icon: (
                      <svg viewBox="0 0 24 24" fill="none" className="lp-integ-logo">
                        <rect width="24" height="24" rx="6" fill="#0058CC"/>
                        <path d="M12 4.5l6 3.5v7l-6 3.5-6-3.5v-7l6-3.5z" stroke="#fff" strokeWidth="1.5" fill="none"/>
                      </svg>
                    ),
                    badge: 'Coming Soon',
                    actionType: 'coming'
                  ...
                  {
                    name: 'MS Teams',
                    desc: 'Post status updates to a Microsoft Teams channel.',
                    icon: (
                      <svg viewBox="0 0 24 24" fill="none" className="lp-integ-logo">
                        <rect width="24" height="24" rx="6" fill="#5059C9"/>
                        <circle cx="9.3" cy="9.8" r="2.8" fill="#fff"/>
                        <circle cx="15.3" cy="8.3" r="1.8" fill="#fff" opacity="0.75"/>
                        <rect x="5.8" y="12.3" width="7" height="6" rx="2" fill="#fff"/>
                      </svg>
                    ),
                    badge: 'Coming Soon',
                    actionType: 'coming'
                  ...
                  {
                    name: 'Google Chat',
                    desc: 'Send alerts to a Google Chat space.',
                    icon: (
                      <svg viewBox="0 0 24 24" className="lp-integ-logo">
                        <path d="M4 4h16a2 2 0 0 1 2 2v9a2 2 0 0 1-2 2H9l-5 4v-4a2 2 0 0 1-2-2V6a2 2 0 0 1 2-2z" fill="#00AC47"/>
                  ...
                  {
                    name: 'Splunk',
                    desc: 'Forward alert events to Splunk for analysis.',
                    icon: (
                      <svg viewBox="0 0 24 24" fill="none" className="lp-integ-logo">
                        <rect width="24" height="24" rx="6" fill="#000000"/>
                        <path d="M12 4l5 4-5 4-5-4 5-4zM7 12l5 4 5-4M7 16l5 4 5-4" stroke="#65A637" strokeWidth="1.6" strokeLinecap="round" strokeLinejoin="round"/>
                      </svg>
                    ),
                    badge: 'Coming Soon',
                    actionType: 'coming'
