...
const IcoApi      = () => <svg width="18" height="18" fill="none" stroke="currentColor" strokeWidth="1.6" strokeLinecap="round" strokeLinejoin="round" viewBox="0 0 24 24"><rect x="3" y="4" width="13" height="9" rx="2"/><path d="M19 9a4 4 0 0 1 0 8h-1"/><path d="M5 13v3a3 3 0 0 0 3 3h6"/></svg>;
          ...
          <Suspense fallback={null}>
            <Routes>
              ...
              <Route path="/api-monitor" element={(() => {
                  const planAcc = { free_trial: freeAccess, bronze: bronzeAccess, silver: silverAccess, gold: goldAccess };
                  const acc = user?.plan ? planAcc[user.plan] : null;
                  const blocked = acc && acc.apiMonitor === false;
