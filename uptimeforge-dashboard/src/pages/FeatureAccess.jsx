...
export default function FeatureAccess({ readOnly = false }) {
    const DEFAULT_ACC = { pingMonitor: false, pingMonitorIcmp: false, dnsMonitor: false, udpMonitor: false, apiMonitor: false, whatsapp: false, telegram: false, webhook: false, rocketChat: false, slack: false, reports: false };
