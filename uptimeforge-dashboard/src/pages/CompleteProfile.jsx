        ...
        <form onSubmit={handleSubmit} className="cp-form">
          ...
          <div style={{ display:'grid', gridTemplateColumns:'1fr 1fr', gap:14, minWidth:0 }}>
            ...
            <div className="cp-field">
              ...
              <input className="cp-input" type="text" placeholder="e.g. Mumbai, Delhi"
          ...
          <div style={{ display:'grid', gridTemplateColumns:'1fr 1fr', gap:14 }}>
            <div className="cp-field">
              ...
              <select className="cp-input cp-select" value={form.country} onChange={e => setForm({ ...form, country: e.target.value })}>
            ...
            <div className="cp-field">
              ...
              {form.country === 'India' ? (
                ...
                <input className="cp-input" type="text" placeholder="Enter state / province"
