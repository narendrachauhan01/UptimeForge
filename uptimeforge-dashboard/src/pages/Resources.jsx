    ...
    <div className="term-card">
      ...
      <div className="term-body">
        ...
        <div style={{ borderTop: '1px solid var(--border-color)', padding: '20px 24px' }}>
          ...
          >
            <div className="res-cmd-section-title" style={{ margin: 0, display: 'flex', alignItems: 'center', gap: 8 }}>
              <svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.5" strokeLinecap="round" strokeLinejoin="round" style={{ color: 'var(--primary)', position: 'relative', top: '-1px' }}><path d="M14.7 6.3a1 1 0 0 0 0 1.4l1.6 1.6a1 1 0 0 0 1.4 0l3.77-3.77a6 6 0 0 1-7.94 7.94l-6.91 6.91a2.12 2.12 0 0 1-3-3l6.91-6.91a6 6 0 0 1 7.94-7.94l-3.76 3.76z"/></svg>
              <span>Useful Commands & Troubleshooting</span>
            </div>
            <svg
              width="16"
              height="16"
              ...
              style={{
                color: 'var(--text-muted)',
                transform: showCommands ? 'rotate(180deg)' : 'rotate(0deg)',
                transition: 'transform 0.2s ease',
              }}
            >
          ...
          {showCommands && (
            <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(280px, 1fr))', gap: 20, marginTop: 20, marginBottom: 8, animation: 'fadeIn 0.2s ease' }}>
              {/* Check status */}
