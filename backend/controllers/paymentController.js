...
exports.getPlans = async (req, res) => {
    try {
        ...
        const FREE_DEFAULT = { domainSsl: false, charts: false, pingMonitor: false, pingMonitorIcmp: false, dnsMonitor: false, udpMonitor: false, whatsapp: false, telegram: false, webhook: false, rocketChat: false, slack: false, reports: false };
        const PLAN_DEFAULT = { pingMonitor: false, pingMonitorIcmp: false, dnsMonitor: false, udpMonitor: false, whatsapp: false, telegram: false, webhook: false, rocketChat: false, slack: false, reports: false };
        res.json({
