...
exports.getPlans = async (req, res) => {
    try {
        ...
        res.json({
            ...
            bronzeAccess: settings.bronzeAccess || { pingMonitor: true, whatsapp: true, telegram: true, webhook: true, rocketChat: true },
            silverAccess: settings.silverAccess || { pingMonitor: true, whatsapp: true, telegram: true, webhook: true, rocketChat: true },
            goldAccess:   settings.goldAccess   || { pingMonitor: true, whatsapp: true, telegram: true, webhook: true, rocketChat: true },
