...
exports.getPlans = async (req, res) => {
    try {
        ...
        const FREE_DEFAULT = { domainSsl: false, charts: false, pingMonitor: false, pingMonitorIcmp: false, dnsMonitor: false, udpMonitor: false, apiMonitor: false, whatsapp: false, telegram: false, webhook: false, rocketChat: false, slack: false, discord: false, reports: false };
        const PLAN_DEFAULT = { pingMonitor: false, pingMonitorIcmp: false, dnsMonitor: false, udpMonitor: false, apiMonitor: false, whatsapp: false, telegram: false, webhook: false, rocketChat: false, slack: false, discord: false, reports: false };
        res.json({
...
exports.refundStatus = async (req, res) => {
    try {
        ...
        const statusMap = {
            'created':    { label: '⏳ Initiated',        color: '#f59e0b', desc: 'Refund initiated — processing started' },
            'processed':  { label: '✅ Refund Successful', color: '#10b981', desc: 'Refund successful — amount will be credited to customer in 5-7 working days' },
