...
const DEFAULT_FEATURES = {
    free_trial: [
        ...
        'ok:Email alerts',
        'ok:Telegram alerts',
        'ok:Webhook integration',
        'ok:SSL & domain expiry monitoring',
        'ok:Performance charts',
        'ok:Ping monitor (TCP + ICMP)',
        'ok:Multi-recipient alerts (2)',
    ...
    bronze: [
        'ok:10 sites monitored',
        'limited:2 min check interval',
        'ok:Email alerts',
        'ok:Telegram alerts',
        'ok:Webhook + Rocket.Chat',
        'ok:SSL & domain expiry monitoring',
        'ok:Performance charts',
        'ok:Ping monitor (TCP + ICMP)',
        'ok:DNS monitoring',
        'ok:Reports',
        'ok:Multi-recipient alerts (10)',
        'ok:Alert history logs',
        'no:WhatsApp alerts',
        'no:Slack / Discord',
        'no:Infra monitor',
    ...
    silver: [
        'ok:25 sites monitored',
        'ok:1 min check interval',
        'ok:Email alerts',
        'ok:Telegram alerts',
        'ok:Webhook + Rocket.Chat + Slack',
        'ok:SSL & domain expiry monitoring',
        'ok:Performance charts',
        'ok:Ping monitor (TCP + ICMP)',
        'ok:DNS monitoring',
    ...
    gold: [
        'ok:50 sites monitored',
        'ok:30 sec check interval',
        'ok:Email + WhatsApp alerts',
        'ok:Telegram + all integrations',
        'ok:SSL & domain expiry monitoring',
        'ok:Performance charts',
        'ok:All monitor types (HTTP, Ping, DNS, UDP, API)',
        'ok:Infra monitor (server resources)',
        'ok:Reports',
        'ok:Multi-recipient alerts (30)',
        'ok:Alert history logs',
        'ok:Priority support',
    ],
};
