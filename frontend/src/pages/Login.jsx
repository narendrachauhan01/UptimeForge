...
export default function Login({ onLogin }) {
  ...
  const googleHintBtnRef = useRef(null);
  ...
  useEffect(() => {
    if (!forgotIsGoogle || !googleHintBtnRef.current || !window.google) return;
    window.google.accounts.id.renderButton(googleHintBtnRef.current, {
      type: 'standard', theme: 'outline', size: 'large', width: 400,
    });
  }, [forgotIsGoogle]);
            ...
            <form onSubmit={handleUserLogin} className="login-right-form">
              ...
              {forgotIsGoogle && (
                <div className="login-google-hint">
                  ...
                  <div className="g-btn-wrap" style={{marginTop: 10}}>
                    <button type="button" className="g-btn-custom" tabIndex={-1}>
                    ...
                    <div ref={googleHintBtnRef} className="g-btn-overlay" />
                  </div>
                </div>
              )}
              {forgotSent && (
