...
const IcoRocket   = () => (<svg width="26" height="26" viewBox="0 0 200 200" xmlns="http://www.w3.org/2000/svg"><rect width="200" height="200" rx="44" fill="url(#rcgrad)"/><defs><linearGradient id="rcgrad" x1="0" y1="0" x2="1" y2="1"><stop offset="0%" stopColor="#f5455c"/><stop offset="100%" stopColor="#c0392b"/></linearGradient></defs><path fill="#fff" d="M100 38c-34.794 0-63 24.402-63 54.5 0 13.048 5.163 25.018 13.726 34.387L44 162l18.5-7.5C71.2 158.8 85.1 162 100 162c34.794 0 63-24.402 63-54.5S134.794 38 100 38z"/><path fill="#f5455c" d="M85 82c0-2.21 1.79-4 4-4h22c2.21 0 4 1.79 4 4s-1.79 4-4 4H89c-2.21 0-4-1.79-4-4zm0 16c0-2.21 1.79-4 4-4h14c2.21 0 4 1.79 4 4s-1.79 4-4 4H89c-2.21 0-4-1.79-4-4z"/></svg>);
